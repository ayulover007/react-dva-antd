...
const Collection = ({agentDashboard, loading, onMemberAddSelectChange}) => {
    ...
    series : [
      {
        ...
        type:'bar',
        barWidth: '30%',
        data: agentDashboard.memberCount
      }
    ]
  };
    ...
    series : [
      {
        ...
        type:'bar',
        barWidth: '30%',
        data: agentDashboard.memberStatus[agentDashboard.memberAddSelect]
      }
    ]
  };
    ...
    series : [
      {
        ...
        type:'bar',
        barWidth: '30%',
        data: agentDashboard.cardTotalStatus
      }
    ]
  };
    ...
    series : [
      {
        ...
        barWidth: '30%',
        stack: 'sum',
        data: agentDashboard.cardUsedStatus,
        itemStyle:{
          normal: {color: '#f04134'}
        }
      },
      ...
      <Row gutter={16}>
        <Col span={6}>
          <Card title={<div><Icon type="user" style={{marginRight: '10px'}}/>注册用户总数</div>} bordered={false}>
            <div style={{fontSize: 50, textAlign: 'center', color: '#00a854', height: '150px', lineHeight: '150px'}}>{agentDashboard.userSize}</div>
          </Card>
        </Col>
        <Col span={6}>
          <Card
          ...
          >
            <div style={{fontSize: 20, textAlign: 'center', color: '#f04134', height: '150px'}}>
              <p style={{paddingTop: '30px'}}>日增：{agentDashboard.userAdded[0]}</p>
              <p>周增：{agentDashboard.userAdded[1]}</p>
              <p>月增：{agentDashboard.userAdded[2]}</p>
            </div>
          </Card>
        </Col>
        <Col span={6}>
      ...
      <Row gutter={16}>
        <Col span={6}>
          <Card title={<div><Icon type="user" style={{marginRight: '10px'}}/>代理商总数</div>} bordered={false}>
            <div style={{fontSize: 50, textAlign: 'center', color: '#00a854', height: '150px', lineHeight: '150px'}}>{agentDashboard.agentSize}</div>
          </Card>
        </Col>
        <Col span={6}>
          <Card
          ...
          >
            <div style={{fontSize: 20, textAlign: 'center', color: '#108ee9', height: '150px'}}>
              <p style={{paddingTop: '30px'}}>日增：{agentDashboard.agentStatus[0]}</p>
              <p>周增：{agentDashboard.agentStatus[1]}</p>
              <p>月增：{agentDashboard.agentStatus[2]}</p>
            </div>
          </Card>
        </Col>
        <Col span={6}>
